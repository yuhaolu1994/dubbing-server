...
const accountSid = 'ACf57c44112b534911771fe9fb12952b95';
const authToken = '04cb8bce878b1d3ef862b4bb3080deab';
...
exports.send = function (phoneNumber, msg) {
    return new Promise(function (resolve, reject) {
        if (!phoneNumber) {
            return reject(new Error('phone number is null'));
        }
        ...
        let options = {
            ...
            path: '/v1/send.json',
            method: 'POST',
            auth: 'api:key-d2dff330101ffd9a216d9ed2e356a8bd',
            agent: false,
        ...
        let req = https.request(options, function(res){
            if (res.statusCode === 404) {
                reject(new Error('SMS server no response'));
                return;
            }
